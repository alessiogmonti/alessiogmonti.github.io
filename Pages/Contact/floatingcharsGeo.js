...
(function() {
  ...
  sample.FloatingCharsGeometry.prototype.init = function() {
    ...
    // attributes
    this.setAttribute('position',     new THREE.BufferAttribute(new Float32Array(vertices),     3));  // vec3
    this.setAttribute('randomValues', new THREE.BufferAttribute(new Float32Array(randomValues), 3));  // vec3
    this.setAttribute('charIndex',    new THREE.BufferAttribute(new Float32Array(charIndices),  1));  // float
    this.setAttribute('uv',           new THREE.BufferAttribute(new Float32Array(uvs),          2));  // vec2
